...
public class CompanyPageValidations {
	
	public void allMethods()
	{
	// objects and variables instantiation
	WebDriver driver = new FirefoxDriver();
	String appUrl = "https://google.com";driver.get(appUrl);
	...
	boolean submitbuttonPresence = driver.findElement(By.id("gbqfba"))
			.isDisplayed();System.out.println(submitbuttonPresence);

	// enter the keyword in the “Google Search” text box by which we would want to
	// make the request
	WebElement searchTextBox = driver
			.findElement(By.id("gbqfq"));searchTextBox.clear();searchTextBox.sendKeys("Selenium");
	...
	driver.close();System.out.println("Test script executed successfully.");
